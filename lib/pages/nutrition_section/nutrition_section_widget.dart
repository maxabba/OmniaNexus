...
import 'nutrition_section_model.dart';
export 'nutrition_section_model.dart';
...
class _NutritionSectionWidgetState extends State<NutritionSectionWidget> {
  late NutritionSectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NutritionSectionModel());
            ...
            children: [
              Align(
                ...
                child: FlutterFlowPdfViewer(
                  assetPath: 'assets/pdfs/TRIMAGNESIO_EXTRA_Canvas_ITA.pdf',
