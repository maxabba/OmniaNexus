...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    omniaNexusAuthUserSubject.add(
      OmniaNexusAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<OmniaNexusAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  OmniaNexusAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = OmniaNexusAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    omniaNexusAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
OmniaNexusAuthUser? currentUser;
